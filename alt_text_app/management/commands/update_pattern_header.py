...
- The head fragment is saved to `alt_text_app_templates/alt_text_app/includes/pattern_header/head.html`.
- The body fragment is saved to `alt_text_app_templates/alt_text_app/includes/pattern_header/body.html`.
...
def resolve_target_paths() -> tuple[pathlib.Path, pathlib.Path, pathlib.Path]:
    ...
    template_dir: pathlib.Path = app_dir / 'alt_text_app_templates' / 'alt_text_app' / 'includes' / 'pattern_header'
